...
void draw_bitmap(const int* bitmap) { // копируем данные из графики info.lbm в графику camera
...
int main(int argc, char* argv[]) { // windows графика на экране // call WinMain from dummy main function in order to have an additional console window
...
int main(int argc, char* argv[]) { // графика на экране для linux и mac
	main_arguments = get_main_arguments(argc, argv);
...
int main(int argc, char* argv[]) { // ASCII графика для всех систем
	main_arguments = get_main_arguments(argc, argv);
...
int main(int argc, char* argv[]) { // без вывода графики на экран или консоль
	main_arguments = get_main_arguments(argc, argv);
