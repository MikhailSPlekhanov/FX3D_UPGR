...
struct Coefs {
	float Cl, Cu, Cnu, Ct, Crho, Cp;
	float real_L, real_u, real_rho, LB_u; int LB_L;
	Coefs(float real_L, int LB_L, float real_u, float LB_u, float real_rho) 
		: real_L{ real_L }, real_u{ real_u }, real_rho{ real_rho }, LB_u{ LB_u }, LB_L{ LB_L } {
		this->Cl = real_L / LB_L;
		this->Cu = real_u / LB_u;
		this->Cnu = Cl * Cu;
		this->Ct = Cl / Cu;
	...
	void print_state() {
		...
		std::cout << "Cnu = " << Cnu << std::endl;
		std::cout << "Ct = " << Ct << std::endl;
		std::cout << "Crho = " << Crho << std::endl;
		std::cout << "Cp = " << Cp << std::endl;
	}
	void print_conditions() {
		std::cout.precision(4);
		std::cout << "real distance = " << this->real_L << std::endl;
		std::cout << "LB distance = " << this->LB_L << std::endl;
		std::cout << "real velocity = " << this->real_u << std::endl;
		std::cout << "LB velocity = " << this->LB_u << std::endl;
		std::cout << "real density = " << this->real_rho << std::endl;
	}
};
