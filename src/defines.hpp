...
#define GRAPHICS_U_MAX 0.15f // maximum velocity for velocity coloring in units of LBM lattice speed of sound (c=1/sqrt(3)) (default: 0.2f)
...
#define GRAPHICS_STREAMLINE_LENGTH 32 // set maximum length of streamlines
